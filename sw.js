...
const SHELL = [
  ...
  'js/logos.js', 'js/map.js', 'js/places.js', 'js/routing.js', 'js/search.js', 'js/shipped.js', 'js/sync.js', 'js/timeline.js', 'js/today.js', 'js/weather.js',
];
